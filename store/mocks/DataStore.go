...
func (_m *DataStore) AssignArtifact(ctx context.Context, deviceID string, deploymentID string, artifact *model.Artifact) error {
	ret := _m.Called(ctx, deviceID, deploymentID, artifact)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, *model.Artifact) error); ok {
...
func (_m *DataStore) FindAll(ctx context.Context) ([]*model.Artifact, error) {
	ret := _m.Called(ctx)

	var r0 []*model.Artifact
	if rf, ok := ret.Get(0).(func(context.Context) []*model.Artifact); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
...
func (_m *DataStore) FindImageByID(ctx context.Context, id string) (*model.Artifact, error) {
	ret := _m.Called(ctx, id)
...
func (_m *DataStore) ImageByIdsAndDeviceType(ctx context.Context, ids []string, deviceType string) (*model.Artifact, error) {
	ret := _m.Called(ctx, ids, deviceType)

	var r0 *model.Artifact
	if rf, ok := ret.Get(0).(func(context.Context, []string, string) *model.Artifact); ok {
...
func (_m *DataStore) ImageByNameAndDeviceType(ctx context.Context, name string, deviceType string) (*model.Artifact, error) {
...
func (_m *DataStore) ImagesByName(ctx context.Context, artifactName string) ([]*model.Artifact, error) {
...
func (_m *DataStore) InsertImage(ctx context.Context, image *model.Artifact) error {
...
func (_m *DataStore) Update(ctx context.Context, image *model.Artifact) (bool, error) {
	ret := _m.Called(ctx, image)

	var r0 bool
	if rf, ok := ret.Get(0).(func(context.Context, *model.Artifact) bool); ok {
		r0 = rf(ctx, image)
	} else {
		r0 = ret.Get(0).(bool)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *model.Artifact) error); ok {
		r1 = rf(ctx, image)
	} else {
		r1 = ret.Error(1)
	}
